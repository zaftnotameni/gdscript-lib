...
static func is_dash_just_released() -> bool:
  return Input.is_action_just_released(PLAYER_INPUT_DASH)

static func is_dash_pressed() -> bool:
  return Input.is_action_pressed(PLAYER_INPUT_DASH)

static func is_jump_just_pressed() -> bool:
  return Input.is_action_just_pressed(PLAYER_INPUT_JUMP)
