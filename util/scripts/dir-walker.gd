...
@export_group('flags')
@export var enable_scenes:bool
@export var enable_audio:bool
@export var enable_materials:bool
@export var enable_shaders:bool
@export var enable_tilesets:bool
@export var enable_images:bool
