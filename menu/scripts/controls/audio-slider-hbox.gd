...
func setup_label(lbl:Label):
	...
	Z_ControlUtil.control_set_font_size(lbl,32)
...
@onready var volume_getters = {
	BUS.Master: __z.audio.get_volume_master,
	BUS.BGM: __z.audio.get_volume_bgm,
	BUS.SFX: __z.audio.get_volume_sfx,
	BUS.UI: __z.audio.get_volume_ui,
}

@onready var volume_testers = {
	BUS.Master: __z.audio.play_test_master,
	BUS.BGM: __z.audio.play_test_bgm,
	BUS.SFX: __z.audio.play_test_sfx,
	BUS.UI: __z.audio.play_test_ui,
}
